...
<body id="page-top">
<?php
include ("updateDepartamentoP.php");
session_start();
...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            ...
            $id = $_GET['id'];
            $sql = mysqli_query($conn, "SELECT * FROM departamentos WHERE id_departamento='$id'");
            if(mysqli_num_rows($sql) == 0){
                header("Location:showDepartamento.php");
            }else{
                $row = mysqli_fetch_assoc($sql);
            }
            ?>
            <div class="card card-register mx-auto">
                <div class="card-header">Modificar nuevo departamento</div>
                <div class="card-body">
                    <form action="updateDepartamento.php" method="post" name="formDepartamentos">
                    
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-label-group">
                                        <input type="text" id="id" name="id" value="<?php echo $row['id_departamento']; ?>" hidden="hidden">
