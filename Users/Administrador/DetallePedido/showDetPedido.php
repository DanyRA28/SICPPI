...
<?php
    ...
    if(isset($_GET['action']) == 'delete'){
        ...
        $query = mysqli_query($conn, "SELECT * FROM detalle_pedido WHERE id_dpedido='$id_delete'");
        if(mysqli_num_rows($query) == 0){
            ...
            $delete = mysqli_query($conn, "DELETE FROM detalle_pedidos WHERE id_dpedido='$id_delete'");
            if($delete){
               
                header("Location: showDetPedido.php?e=1");
            }else{
              
                header("Location: showDetPedido.php?e=0");
            }
        }
    }
    ...
    if (isset($_GET["e"])){
        ...
        if($error==1){
            ...
            <script type="text/javascript">
                history.pushState(null, "", "showDetPedido.php");
            </script>
        <?php
        }
        elseif($error==2){
...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Tabla mostrar Pedidos-->
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fas fa-table mt-2"></i>
                    Detalle Pedido
                    <a href="addDetPedido.php"><button  type="button" class="btn btn-outline-secondary ml-auto mr-0 my-2 my-md-0 float-right" title="Agregar nuevo">Agregar nuevo Detalle Pedido</button></a>
                </div>
                <div class="card-body">
