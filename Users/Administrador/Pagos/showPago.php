    ...
    if(isset($_GET['action']) == 'delete'){
        ...
        if(mysqli_num_rows($query) == 0){
            ...
            if($delete){
                ...
                header("Location: showPago.php?e=1");
            }else{
              
                header("Location: showPago.php?e=0");
            }
        }
    }
    ...
    if (isset($_GET["e"])){
        ...
        if($error==1){
            ...
            <script type="text/javascript">
                history.pushState(null, "", "showPago.php");
            </script>
        <?php
        }
        elseif($error==2){
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    Pagos
                    <a href="addPago.php"><button  type="button" class="btn btn-outline-secondary ml-auto mr-0 my-2 my-md-0 float-right" title="Agregar nuevo">Agregar nuevo Pago</button></a>
                </div>
                <div class="card-body">
    ...
    $(document).ready(function() {
        var dataTable = $('#lookup').DataTable( {
            ...
            "columns" : [
                ...
                {name: 'botones', "data": 4, 'orderable' : false}
            ]
        } );
    } );
</script>
