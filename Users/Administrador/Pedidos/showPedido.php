...
<?php
    ...
    if(isset($_GET['action']) == 'delete'){
        ...
        $query = mysqli_query($conn, "SELECT * FROM pedidos WHERE id_pedido='$id_delete'");
        if(mysqli_num_rows($query) == 0){
            ...
            $delete = mysqli_query($conn, "DELETE FROM pedidos WHERE id_pedido='$id_delete'");
            if($delete){
               
                header("Location: showPedido.php?e=1");
            }else{
              
                header("Location: showPedido.php?e=0");
            }
        }
    }
    ...
    if (isset($_GET["e"])){
        ...
        if($error==1){
            ...
            <script type="text/javascript">
                history.pushState(null, "", "showPedido.php");
            </script>
        <?php
        }
        elseif($error==2){
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    Pedidos
                    <a href="addPedido.php"><button  type="button" class="btn btn-outline-secondary ml-auto mr-0 my-2 my-md-0 float-right" title="Agregar nuevo">Agregar nuevo pedido</button></a>
                </div>
                <div class="card-body">
    ...
    $(document).ready(function() {
        var dataTable = $('#lookup').DataTable( {
            ...
            "columns" : [
                ...
                {name: 'botones', "data": 6, 'orderable' : false}
            ]
        } );
    } );
</script>
