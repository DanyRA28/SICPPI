...
<?php
    ...
    if(isset($_GET['action']) == 'delete'){
        ...
        $query = mysqli_query($conn, "SELECT * FROM productos WHERE id_producto='$id_delete'");
        if(mysqli_num_rows($query) == 0){
            ...
            $delete = mysqli_query($conn, "DELETE FROM productos WHERE id_producto='$id_delete'");
            if($delete){
               
                header("Location: showProducto.php?e=1");
            }else{
              
                header("Location: showProducto.php?e=0");
            }
        }
    }
    ...
    if (isset($_GET["e"])){
        ...
        if($error==1){
            ...
            <script type="text/javascript">
                history.pushState(null, "", "showProducto.php");
            </script>
        <?php
        }
        elseif($error==2){
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    Productos
                    <a href="addProducto.php"><button  type="button" class="btn btn-outline-secondary ml-auto mr-0 my-2 my-md-0 float-right" title="Agregar nuevo">Agregar nuevo producto</button></a>
                </div>
                <div class="card-body">
