...
<?php
    ...
    if(isset($_GET['action']) == 'delete'){
        ...
        $query = mysqli_query($conn, "SELECT * FROM departamentos WHERE id_departamento='$id_delete'");
        if(mysqli_num_rows($query) == 0){
            ...
            $delete = mysqli_query($conn, "DELETE FROM departamentos WHERE id_departamento='$id_delete'");
            if($delete){
               
                header("Location: showDepartamento.php?e=1");
            }else{
              
                header("Location: showDepartamento.php?e=0");
            }
        }
    }
    ...
    if (isset($_GET["e"])){
        ...
        if($error==1){
            ...
            <script type="text/javascript">
                history.pushState(null, "", "showDepartamento.php");
            </script>
        <?php
        }
        elseif($error==2){
...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Tabla mostrar Departamentos-->
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fas fa-table mt-2"></i>
                    Departamentos
                    <a href="addDepartamento.php"><button  type="button" class="btn btn-outline-secondary ml-auto mr-0 my-2 my-md-0 float-right" title="Agregar nuevo">Agregar nuevo departamento</button></a>
                </div>
                <div class="card-body">
    ...
    $(document).ready(function() {
        var dataTable = $('#lookup').DataTable( {
            ...
            "columns" : [
                ...
                {name: 'botones', "data": 2, 'orderable' : false}
            ]
        } );
    } );
</script>
